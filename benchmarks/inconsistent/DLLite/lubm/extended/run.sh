...
if [[ $all -eq 1 ]]; then
	...
	confstr="--repair=$owlfile -n=1;--repair=$owlfile -n=1 --replimfact=3; --repair=$owlfile -n=1 --replimfact=20;-n=1 --repair=$owlfile --replimpred=2;-n=1 --repair=$owlfile --replimconst=20;-n=1 --repair=$owlfile --repdelpred=InternationalStudent" # (2)
