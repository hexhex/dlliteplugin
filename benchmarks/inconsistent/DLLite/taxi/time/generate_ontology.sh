...
do
	...
	if [[ $RANDOM -le $worksday ]]; then 
		echo "<owl:Thing rdf:about=\"#d$i\"><rdf:type rdf:resource=\"#DayDriver\"/></owl:Thing>" 
	else
		echo "<owl:Thing rdf:about=\"#d$i\"><rdf:type rdf:resource=\"#NightDriver\"/></owl:Thing>"
	fi
