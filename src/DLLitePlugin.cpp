...
#ifdef HAVE_OWLCPP
DLLitePlugin::DLPluginAtom::Actor_collector::Actor_collector(RegistryPtr reg, Answer& answer, CachedOntology& ontology, Type t) : reg(reg), answer(answer), ontology(ontology), type(t){
